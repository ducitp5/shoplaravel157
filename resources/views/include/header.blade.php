...
<?php
    ...
    if($shipping_id){
?>
  								<li><a href="#"><i class="fa fa-star"></i>shipping</a></li>
 <?php 
    }
    else{
?>
								<li><a href="#"><i class="fa fa-star"></i>KO shipping</a></li>
<?php 
    }
...
?>
								<li class="dropdown">
        							...
        							<ul class="dropdown-menu extended logout"> 
        								<li><a href="{{URL::to('/logout-checkout')}}">mail <?= $customer->customer_email; ?></a></li>
        								<li><a href="{{URL::to('/logout-checkout')}}">id : <?= Session::get('customer_id');?></a></li>
