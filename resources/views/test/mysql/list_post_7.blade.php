...
?>	
						<form action="{{url('test/post-assign-lang')}}" method="POST">
                          	...
                          	<tr>
                                ...
                                <td><input type="number" size="5" name="post_id" 	value="{{ $post->post_id }}"></td>
...
<?php 
//        dd($post);                                  //  { App\PostLang }
        
//        dd($post->lang()->get());                          //  Illuminate\Database\Eloquent\Collection
        
//        dd($post->lang());                          //  Illuminate\Database\Eloquent\Relations\BelongsToMany 

//        dd($post->with('lang'));                    //  Illuminate\Database\Eloquent\Builder
        
//        dd($post->with('lang')->get());                    //  Illuminate\Database\Eloquent\Collection
        
//        dd($post->with('lang')->first());                    //  { App\PostLang }

        dd($post->lang()->where('name' , 'Viet')->first());                    //  Illuminate\Database\Eloquent\Collection
    }
?>							
                    </tbody>
              	</table>
