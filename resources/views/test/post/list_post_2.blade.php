...
//    consolelog(myModel::getSql(PostLang2   ::with('cate_post')));

     consolelog("list 78");    
/*
    consolevar2("79"                    , PostLang2::with('cate_post')->get());          
    
    consoletype2("type of 81 - "        , PostLang2::with('cate_post')->get()); 
    
    consolelog("list 800000000000");
    
    consolelog_json2('lp2 81'           , PostLang2::with('cate_post')->get()); 
    consolelog("list 81");  
 */
