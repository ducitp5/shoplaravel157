...
?>       			
            			...
            			<form action="{{url('/assign-roles')}}" method="POST">
                            @csrf
<?php 
        if( ($user->admin_id  == Auth::id())    ||    ($user->admin_id == Session::get('DucAuth_id'))){
?>
...
?>            
                                ...
                                <td><input type="checkbox" name="user_role"   {{  $user->hasRole('user') 	?	 'checked'   :   "" }} > </td>
                              	...
                              	<td>              
                     				...
                     				<p><a  onclick="alert('delete this user')" style="margin:5px 0;" class="btn btn-sm btn-danger" href="{{url('/delete-user-roles/'.$user->admin_id)}}">Xóa user</a></p>
