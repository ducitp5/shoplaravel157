                    ...
                    <div class="position-center">
                        ...
                        <form role="form" action="{{URL::to('/save-product')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input  type="text" 		name="product_name" 	class="form-control "	id="slug" 	placeholder="Tên danh mục"
                                        data-validation				="length" 
                                        data-validation-length		="min3" 
                                        data-validation-error-msg	="Làm ơn điền ít nhất 3 ký tự"   onkeyup="ChangeToSlug();"> 
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input 	type="text" 		name="product_price" 		class="form-control price_format" 
                                        data-validation				="length" 			id="" 		placeholder="Gia Ban"
                            ...
                            <div class="form-group">
                                ...
                                <input 	type="text" 				name="price_cost" 			class="form-control price_format"
                                		data-validation				="length" 
                                		data-validation-length		="min5" 
                                		data-validation-error-msg	="Làm ơn điền số tiền"  	id="" placeholder="Gia goc">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea style ="resize: none"  rows ="8"         class       ="form-control"
                                		  name  ="product_desc"  id   ="ckeditor1" placeholder ="Mô tả sản phẩm"
                                		  required > 
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1">Nội dung sản phẩmm</label>
                                
                                <textarea style="resize: none" rows="8" class="form-control" name="product_content"  id="id4" 
                                		  required   placeholder="Nội dung sản phẩm">
