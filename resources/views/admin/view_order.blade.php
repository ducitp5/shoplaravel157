    ...
    <div class="table-agile-info">
    	...
    	<div class="panel panel-default">
    		...
    		<div class="panel-heading">
    			...
    			<div>Order_code : {{ $order->order_code}}</div>
    			
    			
    		</div>
    		
    		<div>Order_date : {{ $order->order_date}}</div>
...
?>					
    					...
    					<tr class="color_qty_{{$details->product_id}}">
    						...
    						<td>@if($details->product_coupon!='no')		{{$details->product_coupon}} 
...
<?php 
    ...
    if($coupon_condition  ==  1){       // reduice by %
...
?>  			
    							...
    							<form>
    								@csrf 
    								<!-- Ajax via .order_details  treated by  /update-order-qty -->
...
?>    				
    			...
    			<a target="_blank"
    				href="{{url('/print-order/'.$details->order_code)}}">In đơn hàng</a>
    		</div>
