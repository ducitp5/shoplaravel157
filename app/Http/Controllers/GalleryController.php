...
class GalleryController extends Controller
{
    ...
    public function select_gallery(Request $request){
        ...
        if($gallery_count  >  0){
        				                ...
        				                <tr>
                                            ...
                                            <td>
                                                ...
                                                <input      type="file"     class="file_image"      style="width:40%" 
                                                            ...
                                                            data-gal_id="'.$gal->gallery_id.'"      id="file-'.$gal->gallery_id.'"

                                                            name="file"     accept="image/*" />                                                
                                            </td>

                                            <td>
                                            	<button     type="button"      class="btn btn-xs btn-danger delete-gallery"
            ...
            $output     .=  '           <tr><td colspan="4">    Sản phẩm chưa thư viện ảnh  </td></tr>  ';
