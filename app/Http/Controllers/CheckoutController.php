...
class CheckoutController extends Controller
{
    ...
    public function add_customer(Request $request){
        ...
        $res                            =    DB::table('tbl_customers')
        
                                                ->where('customer_email' ,   $request->customer_email)      ->first();
        
        if($res){
            
            Session::put('message2'          ,   'this email allready registred');
            
            return          redirect()->back();//  ->with('message2' , 'this email allready registred');
            ...
            Session::put('message'          ,   'chúc mừng bạn đã đăng ký thành công');
    ...
    public function checkout(Request $request){
        ...
        $meta_desc          =    "Thong tin thanh toán";
        $meta_keywords      =    "Thong tin thanh toán";
        $meta_title         =    "Thong tin thanh toán";
    ...
    public function login_customer(Request $request){
        ...
        if($customer){
            ...
            Session::put('message'          ,   'bạn đã đăng nhập thành công');
            
            return Redirect::to('/checkout');
        }
        else{
            
            Session::put('message'          ,   'pass or email not correct');
...
//         echo("<script>console.log('Ship is created " .json_encode($shipping)."');</script>");
         ...
         $order->customer_id            =    Session::get('customer')->customer_id;
